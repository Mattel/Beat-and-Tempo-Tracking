...
#define BTT_DEFAULT_AUTOCORRELATION_EXPONENT         0.5f   // for generalized autocorrelation
...
#define BTT_DEFAULT_ONSET_TREHSHOLD                  0.1f   // std devs above mean OSS signal
#define BTT_DEFAULT_ONSET_TREHSHOLD_MIN              5.0f   // raw flux value
...
#define BTT_DEFAULT_GAUSSIAN_TEMPO_HISTOGRAM_DECAY   0.999f //
#define BTT_DEFAULT_GAUSSIAN_TEMPO_HISTOGRAM_WIDTH   5      // oss samples starndard deviation
#define BTT_DEFAULT_CBSS_ALPHA                       0.9f   // 90% old, 10 percent new
...
#define BTT_DEFAULT_XCORR_PULSE_LOCATIONS            {0, 1, 1.5f, 2, 3, 4, 4.5f, 6}
#define BTT_DEFAULT_XCORR_PULSE_VALUES               {2.0f, 1.0f, 0.5f, 1.5f, 1.5f, 0.5f, 0.5f, 0.5f}

/*--------------------------------------------------------------------*/
typedef struct Opaque_BTT_Struct BTT;

typedef void (*btt_onset_callback_t)             (void* SELF, unsigned int sample_time);
typedef void (*btt_beat_callback_t)              (void* SELF, unsigned int sample_time);
...
BTT*      btt_new                                (int spectral_flux_stft_len, int spectral_flux_stft_overlap,
                                                  ...
                                                  int onset_threshold_len,    int cbss_length, float sample_rate,
...
void      btt_set_noise_cancellation_threshold   (BTT* self, float dB /*negative*/);
